...
class AiPromptBuilder
  ...
  def organize_format_rule
    case format
    when 'bullet'
      '各階層の項目は、ハイフン（-）を使った箇条書き風の見た目で表現してください。'
    when 'numbered'
      '各階層の項目は、番号付きリスト風の見た目で表現してください。'
    when 'emoji'
      '各階層の項目は、内容に合う絵文字を適度に使って見やすく表現してください。'
    else
      '各階層の項目は、シンプルで読みやすい形で表現してください。'
    end
  end

  def plain_output_rule
    'コードブロック（```）、見出し記号、余計な前置きや説明文は付けず、結果本文だけを出力してください。'
  end
end
